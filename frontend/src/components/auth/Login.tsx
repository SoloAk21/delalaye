      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-boxdark-2">
        <div className="w-full   ">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 p-6 sm:p-10 lg:p-12 border-t lg:border-t-0 lg:border-l border-stroke dark:border-strokedark">
              <h2 className="mb-8 text-2xl font-bold text-body dark:text-bodydark sm:text-3xl">
                Sign In to Delaochu Admin
              </h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="mb-2 block text-sm font-medium text-body dark:text-bodydark">
                    Email
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke dark:border-strokedark bg-white dark:bg-boxdark py-3 pl-4 pr-10 text-body dark:text-bodydark focus:outline-none focus:ring-1 focus:ring-primary dark:focus:ring-primary"
                      required
                    />
                ...
                >
                  {status === "loading" ? (
                    ...
                    <input
                      type="submit"
                      value="Sign In"
                      className="w-full cursor-pointer rounded-lg bg-primary py-3 text-white font-medium hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors"
                    />
                  )}
                </motion.div>
              </form>{" "}
