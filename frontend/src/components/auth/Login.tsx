        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full lg:block lg:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20 text-secondary">
              Brokered Connections, Endless Possibilities: Where Your Needs Meet Expert Solutions!
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2">
            <div className="w-full p-4 sm:p-12.5 lg:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-secondary dark:text-white sm:text-title-xl2">
                Sign In to Delaochu Admin
              </h2>

              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium text-secondary dark:text-white">
                    Email
                  </label>
